    ...
    <ScrollView style={s.scroll} contentContainerStyle={s.content}>
      ...
      <View style={s.hero}>
        ...
        <Text style={s.heroSub}>
          Everything about child nutrition, development, and anemia prevention.
        </Text>
        {totalDone > 0 && (
          <View style={s.progressBox}>
            ...
            <Text style={s.progressLabel}>{totalDone}/{totalCheckable} completed</Text>
          </View>
        )}
      </View>
      ...
      <View style={s.tipCard}>
        ...
        <Text style={s.tipText}>
          Liver is the richest source of iron. Including it in your child's diet 1–2 times per week can significantly reduce anemia risk. 🥩
        </Text>
      </View>
